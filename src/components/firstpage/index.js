      ...
      <Box h="100vh">
        ...
        <Flex bg="#FFC947" className="title-wrapper" color="#1D1616" p="0 5%">
          <Box w="50%">
            ...
            <Box>
              <Button onClick={() => window.location.href = "https://aquarizz-9687c.web.app"}>
                Join the Community
              </Button>
            </Box>
          </Box>
        ...
        <Flex flexDirection="column" p="32px 0" justify="center" align="center">
          <Button className="joinBtn" size="lg" bg="#FFC947" onClick={() => window.location.href = "https://aquarizz-9687c.web.app"}>
